...
const Footer:React.FC = () => {
  return (
    <div id="footer" className="mx-auto px-4 my-20">
        <h1 className="text-2xl sm:text-4xl mb-4 mt-2">
          ...
          <div className='grid grid-rows place-items-center mt-20'>
              ...
              <h2 className='text-lg sm:text-3xl mt-5 opacity-75'>새로운 기술의 대한 두려움 없이</h2>
              <h2 className='text-lg sm:text-3xl my-5 opacity-75'>항상 도전하고 발전하는 개발자가 되겠습니다.</h2>
