...
const NavHeader:React.FC = () => {
  ...
  return (
    <nav className="dark:bg-gray-900 bg-white opacity-85 shadow-md fixed top-0 inset-x-0 text-white z-50">
          ...
          <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:block sm:ml-6 ">
              <div className="flex space-x-4">
                ...
                <a href="#services" className="dark:text-white text-black hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">About</a>
                <a href="#about" className="dark:text-white text-black hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Project</a>
      ...
      <div className={`sm:hidden ${isOpen ? 'block' : 'hidden'}`}>
        <div className="px-2 pt-2 pb-3 space-y-1">
          ...
          <a href="#services" className="text-gray-300 hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium">About</a>
          <a href="#about" className="text-gray-300 hover:bg-gray-700 block px-3 py-2 rounded-md text-base font-medium">Project</a>
